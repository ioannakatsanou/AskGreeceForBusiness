// Mock procurement opportunities for the backend scaffold. IDs intentionally match
// the frontend's mock set so the two interoperate during Phase 2. Replaced by the
// ESIDIS/KIMDIS adapters in a later phase.
...
export const OPPORTUNITIES = [
  {
    ...
    contractingAuthority:
      "6th Health Region of Peloponnese, Ionian Islands, Epirus & Western Greece",
    ...
    ai: {
      executiveSummary:
        "A 24-month engagement to deliver a managed Security Operations Center (SOC), 24/7 threat monitoring, and incident response for a regional health authority spanning multiple hospitals. Strong fit for mid-sized cybersecurity firms that can staff a continuous monitoring team and demonstrate ISO 27001 governance.",
      keyRequirements: [
        ...
        { label: "Financial standing", detail: "Average annual turnover >= 800,000 EUR.", category: "financial" },
      ],
    },
  },
  {
    ...
    ai: {
      executiveSummary:
        "Migration of a legacy citizen-services platform to a public cloud, including re-architecture for high availability, a CI/CD pipeline, and staff knowledge transfer. Attractive for cloud-native teams with a track record of public-sector modernisation.",
      keyRequirements: [
  ...
  },
  {
    ...
    ai: {
      executiveSummary:
        "A large-scale ERP rollout covering finance, procurement, HR, and logistics modules for a major port authority. Best suited to established system integrators; smaller firms would likely need a consortium or partner to qualify.",
      keyRequirements: [
        ...
        { label: "Turnover >= 1.5M EUR", detail: "Demonstrated financial capacity.", category: "financial" },
  ...
  },
  {
    ...
    ai: {
      executiveSummary:
        "An advisory engagement to shape a national digital-transformation roadmap, including stakeholder workshops, maturity assessment, and an implementation plan. A strong fit for boutique consultancies with public-sector advisory credentials.",
      keyRequirements: [
  ...
  },
  {
    ...
    ai: {
      executiveSummary:
        "Design and build of new citizen-facing tax e-services with high security and accessibility requirements, integrating with existing government registries. Well matched to software houses with secure web-application experience.",
      keyRequirements: [
  ...
  },
  {
    ...
    ai: {
      executiveSummary:
        "Upgrade of campus-wide network infrastructure including core switching, Wi-Fi 6 coverage, and segmentation for research labs. Suited to infrastructure integrators with regional presence and a small, certified delivery crew.",
      keyRequirements: [
